...
<body>
  <div class="bg-logo">
    <img class="logo" src="../assets/img/logo/696px-Bandung_coa.png" />
    <div class="isi-surat">
          ...
          <tbody>
            <tr>
              <td align="center" colspan="2">
                <br />
                <b><u>
                    <font size="4">SURAT KETERANGAN TIDAK MAMPU <br /></font>
                  </u></b>
      ...
      <div class="content">
        <table border="0" align="center" style="width: 650px;">
          <tr>
            <td colspan="2">
              <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                Ketua Rukun Warga (RW) <?php echo $surat_val['no_rw']; ?> Desa <?php echo $surat_val['nama_desa']; ?> Kecamatan Cikelet
          ...
          <tr>
            <td colspan="2">
              <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                Menurut Sepengetahuan kami dan catatan yang ada di RT.<?php echo $surat_val['no_rt']; ?>
                RW.<?php echo $surat_val['no_rw']; ?> Desa <?php echo $surat_val['nama_desa']; ?>, Bahwa orang tersebut diatas Keluarga
          ...
          <tr>
            <td colspan="2">
              <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                Persyaratan <?php echo $surat_val['keperluan_surat']; ?>.
              </label>
            </td>
          </tr>
          <tr>
