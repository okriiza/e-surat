...
$sql = "SELECT * FROM rw WHERE id='$id'";
      ...
      <div class="panel-body">
            ...
            <div class="row">
               <div class="col-md">
                  <div class="form-group">
                     ...
                     <input type="number" class="form-control form-control-user" name="norw" value="<?php echo $row['no_rw']; ?>">
                  </div>
                  <div class="form-group">
                     <label for="">Nama RT </label>
                     <input type="text" class="form-control form-control-user" name="namarw" value="<?php echo $row['nama_rw']; ?>">
                  </div>
                  <div class="form-group">
         ...
         if (isset($_POST['ubah'])) {
            ...
            if (!empty($img && $file)) {
               ...
               $query = "UPDATE rw SET no_rw='$norw',nama_rw='$nama_rw', ttd64='$img', ttdimg='$file' WHERE id='$_GET[id]'";
               mysqli_query($koneksi, $query);
            } else {
               $query = "UPDATE rw SET no_rw='$norw',nama_rw='$nama_rw' WHERE id='$_GET[id]'";
               mysqli_query($koneksi, $query);
            }

            $insert_id = $koneksi->insert_id;
            if (!empty($password)) {
               $query2 = "UPDATE user SET username='$username',jabatan='3',table_join='$insert_id' WHERE id='$_GET[id]'";
               mysqli_query($koneksi, $query2);
            } else {
               $query2 = "UPDATE user SET username='$username', password='$password',jabatan='3',table_join='$insert_id' WHERE id='$_GET[id]'";
               mysqli_query($koneksi, $query2);
            }
